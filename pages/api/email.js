...
export default async function handler(req, res) {
  const EMAIL = "zigtradeoption@gmail.com";
  ...
  <mj-body background-color="#ffffff" font-size="13px">
    ...
    <mj-section background-color="#333333" padding-bottom="20px" padding-top="20px">
      <mj-column vertical-align="middle" width="100%">
        ...
        <mj-text align="left" color="#ffffff" font-size="15px" font-family="open Sans Helvetica, Arial, sans-serif" padding-left="25px" padding-right="25px">Thanks, <br /> The Zig Trade Option Team</mj-text>
      </mj-column>
    </mj-section>
  </mj-body>
</mjml>`);
  // let info = await transporter.sendMail({
  //   from: '"Zig Trade Option" <contact@zig tradeoption.com>', // sender address
  ...
  let adminInfo = await transporter.sendMail({
    from: 'Zig Trade Option <zigtradeoption@gmail.com>', // sender address
    to: `zigtradeoption@gmail.com`, // list of receivers
    ...
    html: `
             <html>
                <body>
                    ...
                    <footer>
                      <p style="text-align: center;">Zig Trade Option</p>
