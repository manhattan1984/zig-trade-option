...
import sty from "./PlasmicButton.module.css"; // plasmic-import: O1n4fOqLki7Y/css
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___9Biy)}
                role={"img"}
              />
            ),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.contentContainer, {
          ...
          [sty.contentContainerghost_color_teal]:
            hasVariant($state, "color", "teal") &&
            hasVariant($state, "ghost", "ghost"),
          [sty.contentContainerghost_color_white]:
            hasVariant($state, "ghost", "ghost") &&
            hasVariant($state, "color", "white"),
        ...
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetChildren, {
            ...
            [sty.slotTargetChildrenghost_color_teal]:
              hasVariant($state, "color", "teal") &&
              hasVariant($state, "ghost", "ghost"),
            [sty.slotTargetChildrenghost_color_white]:
              hasVariant($state, "ghost", "ghost") &&
              hasVariant($state, "color", "white"),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__lY99T)}
                role={"img"}
              />
            ),
